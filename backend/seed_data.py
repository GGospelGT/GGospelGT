...
async def seed_tradespeople(count: int = 100):
    ...
    for i in range(count):
        ...
        tradesperson_data = {
            ...
            "description": f"Professional {trade_cats[0].lower()} with {random.randint(5, 25)} years of experience. Specializing in high-quality workmanship and customer satisfaction. Fully insured and qualified.",
